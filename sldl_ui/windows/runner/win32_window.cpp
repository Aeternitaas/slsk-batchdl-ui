...
// Scale helper to convert logical scaler values to physical using
// a screen DPI. The physical value returned is rounded to the nearest int.
...
void Win32Window::UpdateTheme(HWND const window) {
  ...
  DwmSetWindowAttribute(window, 20, &is_dark_mode, sizeof(is_dark_mode));
}
